...
/// A widget that makes it easy to create a internals with a square-ish
...
class ResponsiveScreen extends StatelessWidget {
  /// This is the "hero" of the internals. It's more or less square, and will
  /// be placed in the visual "center" of the internals.
  ...
  /// An area reserved for some static text close to the top of the internals.
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        // This widget wants to fill the whole internals.
        final size = constraints.biggest;
        final padding = EdgeInsets.all(size.shortestSide / 50);
